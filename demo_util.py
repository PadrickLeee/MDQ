...
def get_titok_tokenizer(config):
    ...
    # tokenizer.load_state_dict(torch.load(config.experiment.tokenizer_checkpoint, map_location="cpu", weights_only=False))
    tokenizer.load_state_dict(load_file(config.experiment.tokenizer_checkpoint, device="cpu"))
    tokenizer.eval()
...
def get_titok_generator(config):
    ...
    generator.load_state_dict(load_file(config.experiment.generator_checkpoint, device="cpu"))
    generator.eval()
