...
class ReconstructionLoss_Stage1(torch.nn.Module):
    ...
    def _forward_generator(self,
        ...
        loss_dict = dict(
            ...
            # codebook_loss=quantizer_loss["codebook_loss"].detach(),  # original
            codebook_loss=quantizer_loss["entropy_loss"].detach(),     # for LFQ 
        )
...
class ReconstructionLoss_Stage2(torch.nn.Module):
    ...
    def _forward_generator(self,
        ...
        loss_dict = dict(
            ...
            # codebook_loss=extra_result_dict["codebook_loss"].detach(),     # original
            codebook_loss=extra_result_dict["entropy_loss"].detach(),        # for LFQ
            d_weight=d_weight,
